...
function draw() {
  ...
  for (let i = 0; i < faces.length; i++) {
    ...
    console.log('rjfl', faceWidth);

    let mouseDist = calcMouthOpen(face);

    let normalMouth = mouseDist / faceWidth;
    console.log('ad', normalMouth);
    console.log.console // let mouseDist = calcMouthOpen(face);
      .log(mouseDist);
    let fWeight = map(normalMouth, 0, 100, 100, 900);
